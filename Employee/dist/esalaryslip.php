<?php
  ...
  $data = "SELECT * FROM salaryslip WHERE employee_name='$name'";
                  ...
                  <table id="myProjectTable" class="table table-hover align-middle mb-0" style="width:100%">
                    <thead>
                      <tr style="text-align: center;">
                        ...
                        <th style="background-color: #222222; color: white;" colspan="2">Action</th>
                      </tr>
                    </thead>
                    <?php
                    ...
                    ?>
                      <tr style="text-align: center;">
                        ...
                        <td><a href="#?download_id=<?php echo $data2['slip_id'] ?>" class="btn btn-primary">Download PDF</a></td>
