<div class="sidebar px-4 py-4 py-md-5 me-0">
        <div class="d-flex flex-column h-100">
            <a href="edashboard.php" class="mb-0 brand-icon">
                ...
                <span class="logo-text">HR Navigator</span>
            </a>
            <!-- Menu: main ul -->
            ...
            <ul class="menu-list flex-grow-1 mt-3">
                <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse show" id="dashboard-Components">
                        <li><a class="ms-link active" href="edashboard.php"> <span>Dashboard</span></a></li>
                ...
                <li  class="collapsed">
                    ...
                    <ul class="sub-menu collapse" id="project-Components">
                        <li><a class="ms-link" href="eprojects.php"><span>Projects</span></a></li>
                        <li><a class="ms-link" href="etask.php"><span>Tasks</span></a></li>
                ...
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#tikit-Components" href="#"><i
                            class="icofont-ticket"></i> <span>Reports</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="tikit-Components">
                        <li><a class="ms-link" href="ereport.php"> <span>Reports View</span></a></li>
                        <!-- <li><a class="ms-link" href="ticket-detail.html"> <span>Reports Detail</span></a></li> -->
                    </ul>
                </li>
                <!-- <li class="collapsed">
                ...
                <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse" id="emp-Components">
                        ...
                        <li><a class="ms-link" href="eholidays.php"> <span>Holidays</span></a></li>
                        <li><a class="ms-link" href="eattendance.php"> <span>Attendance Employees</span></a></li>
                        <!-- <li><a class="ms-link" href="attendance.php"> <span>Attendance</span></a></li> -->
                        <li><a class="ms-link" href="eleave.php"> <span>Leave Request</span></a></li>
                ...
                <li class="collapsed">
                    ...
                    <i class="icofont-ui-note"></i> <span>Salaryslip</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                    ...
                    <ul class="sub-menu collapse" id="menu-Componentsone">
                        ...
                        <li><a class="ms-link" href="esalaryslip.php"><span>Download Salaryslip</span> </a></li>
                    </ul>
                </li>
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#payroll-Components" href="#">
                    <i class="icofont-money"></i><span>Payroll</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="payroll-Components">
                    <li><a class="ms-link active" href="epayments.php"><span>Payments</span> </a></li>
                        
                    </ul>
                </li>
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#app-Components" href="#">
                    <i class="icofont-computer"></i> <span>Digital</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="app-Components">
                        <li><a class="ms-link" href="ecalendar.php"> <span>Calander</span></a></li>
                        <!-- <li><a class="ms-link" href="chat.php"><span>Chat</span></a></li> -->
                        
                    </ul>
                </li>
                <li><a class="m-link" href="https://wa.me/+919512473156?text=Hellow%20"><i class="icofont-whatsapp"></i><span>Whatshapp</span></a></li>
                <li><a class="m-link" href="signin/eback.php"><i class="icofont-arrow-left"></i><span>Back</span></a></li>
