!(function (e, t) {
  ...
  try {
    k.apply((t = a.call(r.childNodes)), r.childNodes),
      t[r.childNodes.length].nodeType;
  } catch (e) {
    k = {
      apply: function (e, t) {
        le.apply(e, a.call(t));
    ...
    if (!i && (Pe(e), (e = e || C), A)) {
      ...
      if (!(he[t + " "] || (f && f.test(t)))) {
        if (((c = t), (u = e), 1 === d && (be.test(t) || ye.test(t)))) {
          for (
            ((u = (Ae.test(t) && Ne(e.parentNode)) || e) == e && g.scope) ||
              ((s = e.getAttribute("id"))
    ...
    return (
      e != C &&
        ...
        i.msMatchesSelector &&
          ...
          (e = C.defaultView) &&
          e.top !== e &&
          e.addEventListener("unload", ke),
        (g.getById = De(function (e) {
          return (
            (i.appendChild(e).id = T.expando),
    ...
    return (
      ...
      l(function (e, t, n, i) {
        ...
        if ((g ? g(f, (a = v || (e ? h : u || m) ? [] : t), n, i) : (a = f), m))
          for (r = Re(a, c), m(r, [], n, i), o = r.length; o--; )
            (s = r[o]) && (a[c[o]] = !(f[c[o]] = s));
        if (e) {
          if (v || h) {
            if (v) {
  ...
  function Be(m, v) {
    function e(e, t, n, i, r) {
      ...
      for (r && (re = t == C || t || r); c !== g && null != (o = h[c]); c++) {
        if (b && o) {
          for (
            s = 0, t || o.ownerDocument == C || (Pe(o), (n = !A));
            (a = m[s++]);
  ...
  function ze(e, t, n, i) {
      ...
      for (
        ...
        if (
          ...
          (i = l(
            ...
            (Ae.test(o[0].type) && Ne(t.parentNode)) || t
          ))
        ) {
    ...
    return (
      (c || $e(e, u))(i, t, !A, n, !t || (Ae.test(e) && Ne(t.parentNode)) || t),
      n
    );
  }
  ...
  (T.filter = function (e, t, n) {
    ...
    T.fn.extend({
      ...
      is: function (e) {
        return !!Qe(
          this,
          "string" == typeof e && Ue.test(e) ? T(e) : e || [],
          !1
        ).length;
      },
    });
          ...
          s = {
            ...
            then: function (t, n, i) {
              ...
              return T.Deferred(function (e) {
                o[0][3].add(c(0, e, y(i) ? i : tt, e.notifyWith)),
                  o[1][3].add(c(0, e, y(t) ? t : tt)),
                  o[2][3].add(c(0, e, y(n) ? n : nt));
              }).promise();
            },
            promise: function (e) {
  ...
  var rt = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/,
    ot =
      ...
      T.Deferred());
  function st() {
    x.removeEventListener("DOMContentLoaded", st),
  ...
  (T.fn.ready = function (e) {
    ...
    ("loading" !== x.readyState && !x.documentElement.doScroll)
      ...
      : (x.addEventListener("DOMContentLoaded", st),
  ...
  function Ot(e, t, n, i, r) {
    ...
    for (u.textContent = "", f = 0; (o = d[f++]); )
      if (i && -1 < T.inArray(o, i)) r && r.push(o);
        ...
        ((l = bt(o)), (s = m(u.appendChild(o), "script")), l && kt(s), n)
      )
  ...
  function Bt(n, i, r, o) {
    ...
    if (
      ...
      for (a = (s = T.map(m(e, "script"), Ft)).length; u < d; u++)
        (l = e),
          u !== f &&
            ((l = T.clone(l, !0, !0)), a) &&
            T.merge(s, m(l, "script")),
          r.call(n[u], l, u);
      if (a)
  ...
  function $t(e, t, n) {
    for (var i, r = t ? T.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
      n || 1 !== i.nodeType || T.cleanData(m(i)),
        i.parentNode &&
          (n && bt(i) && kt(m(i, "script")), i.parentNode.removeChild(i));
    return e;
  }
  T.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (t)
        if (n)
          for (o = o || m(e), s = s || m(u), i = 0, r = o.length; i < r; i++)
            Wt(o[i], s[i]);
        else Wt(e, u);
    ...
    T.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (T.cleanData(m(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
  ...
  function gn(e, t, n, i, r, o) {
    ...
    for (; s < 4; s += 2)
      "margin" === n && (c += T.css(e, n + vt[s], !0, r)),
        i
          ? ("content" === n && (l -= T.css(e, "padding" + vt[s], !0, r)),
            "margin" !== n &&
              (l -= T.css(e, "border" + vt[s] + "Width", !0, r)))
          : ((l += T.css(e, "padding" + vt[s], !0, r)),
            "padding" !== n
              ? (l += T.css(e, "border" + vt[s] + "Width", !0, r))
              : (a += T.css(e, "border" + vt[s] + "Width", !0, r)));
    return (
      !i &&
        0 <= o &&
        (l +=
    ...
    class hi extends t {
      ...
      _keydown(t) {
        if (["ArrowLeft", ai, "ArrowUp", li, ci, "End"].includes(t.key)) {
          ...
          let e;
          (e = [ci, "End"].includes(t.key)
            ? i[t.key === ci ? 0 : i.length - 1]
            : ((n = [ai, li].includes(t.key)), U(i, t.target, n, !0))) &&
            (e.focus({ preventScroll: !0 }), hi.getOrCreateInstance(e).show());
        }
      }
      _getChildren() {
