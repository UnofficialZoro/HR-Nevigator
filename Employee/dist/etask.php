...
if(isset($_POST['search_query'])) {
    ...
    $data = "SELECT * FROM hr_task WHERE task_assign_person='$name' AND (task_name LIKE '%$search_query%' OR task_category LIKE '%$search_query%' OR description LIKE '%$search_query%')";
} else {
    $data = "SELECT * FROM hr_task WHERE task_assign_person='$name'";
}
$data1 = mysqli_query($con, $data);
...
<div id="mytask-layout">
    ...
    ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="project_name" aria-label="Default select Project Category">
                            <option style="display: none;">Select Project Name</option>
                            <?php
                                    $delete1="SELECT * FROM hr_project WHERE project_id";
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <form method="POST" action="etask.php">
                    <div class="input-group" style="width: 40%; margin-left:164%">
                        <input type="text" class="form-control" placeholder="Search Task" name="search_query">
                ...
                <div class="card-body">
                    <table id="myProjectTable" class="table table-hover align-middle mb-0 text-center" style="width:100%">
                        ...
                        <tr>
                            ...
                            <td><b><?php echo $data2['task_name']?></b></td>
                            ...
                            <td><a href="etaedit.php?edit=<?php echo $data2['task_id']; ?>"onclick="return confirm ('Are You Sure?')"><i class="icofont-edit"></i></a>&nbsp;&nbsp;&nbsp;  
                                <a href="etask.php?delete=<?php echo $data2['task_id']; ?>" onclick="return confirm ('Are You Sure?')"><i class="icofont-ui-delete"></i></a>
                            </td>
