<?php
    ...
    if (isset($_REQUEST['btnlogin'])) {
        ...
        $select = "SELECT * FROM hr_employee WHERE email_id='$email_id' AND `password`='$password'";
        $select1 = mysqli_query($con, $select);
        
        if (mysqli_num_rows($select1) == 1) {
            $select2 = mysqli_fetch_array($select1);
            $_SESSION['employee_id'] = $select2['employee_id'];
                        ...
                        <div class="col-lg-6 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                            <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                                ...
                                <form class="row g-1 p-3 p-md-4" method="POST">
                                    ...
                                    <!-- <div class="col-12 text-center mt-4">
                                        <span class="text-muted">Don't have an account yet? <a href="esignup.php" class="text-secondary">Sign up here</a></span>
                                    </div> -->
                                </form>
                                <!-- End Form -->
                            </div>
