...
if(isset($_REQUEST['btnsubmit']))
    {
        ...
        $update="UPDATE hr_employee SET `password`='$password' WHERE email_id='$id'";
                            ...
                            <form class="row g-1 p-3 p-md-4" method="post">
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        ...
                                        <input type="email" name="email_id" class="form-control form-control-lg" placeholder="xyz@gmail.com" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-2">
                                ...
                                <div class="col-12 text-center mt-4">
                                    <button type="submit" name="btnsubmit" class="btn btn-lg btn-block btn-light lift text-uppercase" onclick="return confirm ('Are You Sure?')">SUBMIT</button>
                                </div>
                                <div class="col-12 text-center mt-4">
                                    <span class="text-muted"><a href="eindex.php" class="text-secondary">Back to Sign in</a></span>
                                </div>
                            </form>
                            <!-- End Form -->
