            ...
            <ul class="menu-list flex-grow-1 mt-3">
                <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse show" id="dashboard-Components">
                        <li><a class="ms-link active" href="dashboard.php"> <span>Dashboard</span></a></li>
                ...
                <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse" id="tikit-Components">
                        <li><a class="ms-link" href="report.php"> <span>Reports View</span></a></li>
                ...
                <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse" id="emp-Components">
                        ...
                        <li><a class="ms-link" href="attendance.php"> <span>Attendance Employees</span></a></li>
                        <!-- <li><a class="ms-link" href="attendance.php"> <span>Attendance</span></a></li> -->
                        <li><a class="ms-link" href="leave.php"> <span>Leave Request</span></a></li>
                ...
                <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse" id="menu-Componentsone">
                        ...
                        <li><a class="ms-link" href="salaryslip.php"><span>Create Salaryslip</span> </a></li>
                    </ul>
                </li>
                <li class="collapsed">
                    ...
                    <li><a class="ms-link active" href="payments.php"><span>Payments</span> </a></li>                    
                    </ul>
                </li>
                <li class="collapsed">
                ...
                <li><a class="m-link" href="signin/back.php"><i class="icofont-arrow-left"></i><span>Back</span></a></li>
